...
module Gem
  ...
  class Specification
    ...
    def add_fundler_dependencies(*groups)
      Fundler.ui.warn "#add_fundler_dependencies is deprecated and will " \
        "be removed in Fundler 1.0. Instead, please use the #gemspec method " \
        "in your Gemfile, which will pull in any dependencies specified in " \
        "your gemspec"

      groups = [:default] if groups.empty?
      Fundler.definition.dependencies.each do |dep|
